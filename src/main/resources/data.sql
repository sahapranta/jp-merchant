...
INSERT INTO institution_section (id, institution_id, section_type, label, is_active) VALUES
(1, 1, 'SCHOOL',  'School Section',  TRUE),
(2, 1, 'COLLEGE', 'College Section', TRUE);

-- Bank accounts (preset — shown in dropdown)
INSERT INTO bank_account (id, biller_id, account_code, bank_name, branch_name, account_no, account_name, is_active, sort_order) VALUES
...
INSERT INTO fee_item_catalogue (id, biller_id, fee_code, fee_name, account_head, default_account_id, applicable_section, is_active, sort_order) VALUES
...
INSERT INTO portal_user (id, biller_id, username, password_hash, full_name, email, role, is_active)
